...
namespace RichEditBoxTest
{
    ...
    public enum FormattedTextEntity {
        ...
        // Mono = 16,
        TextUrl = 128,
        // All = Bold | Italic | Underline | Strikethrough | Mono | TextUrl
        All = Bold | Italic | Underline | TextUrl
    }
    ...
    public partial class FormattedTextBox : RichEditBox {
        ...
        protected override void OnKeyDown(KeyRoutedEventArgs e) {
            ...
            if (e.Key is VirtualKey.Back || VirtualKey.Delete && IsReplaceEmojiEnabled) {
                BeginUndoGroup();
            ...
            } else if (e.Key is VirtualKey.A or VirtualKey.L || (int)e.Key is 188 || 190) {
                var modifiers = WindowContext.KeyModifiers();
                if (modifiers == (VirtualKeyModifiers.Control | VirtualKeyModifiers.Shift)) {
                    return;
                }
            } else if (e.Key is VirtualKey.E || VirtualKey.L || VirtualKey.R || VirtualKey.J || VirtualKey.Q) {
                var modifiers = WindowContext.KeyModifiers();
